...
export const UPGRADE_INTENTS: Record<UpgradeIntentKey, UpgradeIntentBuilder> = {
  ...
  topup_credits: () => ({
    ...
    description:
      'Free workspaces run on their monthly credit allowance. Upgrade to a paid plan to buy top-up credit packs on demand - a one-time purchase that never expires and rolls over indefinitely.',
    highlights: [
      'Buy credit packs on demand - never pause your AI Chatbot mid-month',
      'Top-up credits are one-time and never expire',
