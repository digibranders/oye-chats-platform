      ...
      <div className="flex items-center h-16 px-4 shrink-0">
        <div className="flex items-center gap-3">
          ...
          {isOpen && (
            ...
            >
              {/* Product brand stays constant at the top of the sidebar —
                  the active workspace is already surfaced by the workspace
                  switcher / ACTIVE BOT card below, so leading with the app
                  name here keeps the chrome recognisable across workspaces. */}
              OyeChats
            </motion.span>
          )}
        </div>
