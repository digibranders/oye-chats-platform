            ...
            <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3 min-w-0">
                    <button
                        type="button"
                        onClick={onBack}
                        className="flex items-center gap-1 text-[11px] font-medium text-secondary-500 hover:text-secondary-700:text-secondary-300 transition-colors flex-shrink-0"
                    >
                        <ArrowLeft size={13} />
                        All platforms
                    </button>
                    <div className="w-px h-4 bg-secondary-200 flex-shrink-0" />
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                    <div className="flex items-center gap-1 p-0.5 bg-secondary-100 rounded-lg">
                        <button
                            type="button"
                    ...
                    {steps.map((step, idx) => {
                        ...
                        return (
                            <div key={idx} className="relative">
                                {/* Step number badge */}
                                <div className="absolute -left-8 top-0 w-6 h-6 rounded-full bg-primary-100 flex items-center justify-center">
                                ...
                                {/* Step content */}
                                <div>
                                    <h5 className="text-xs font-bold text-secondary-900">
                                        {step.title}
                                    </h5>
                                        ...
                                        <div className="mt-2 relative group">
                                            ...
                                            <pre
                                                className={`p-4 rounded-xl text-[11px] leading-relaxed overflow-x-auto border font-mono ${env === 'production'
                                                        ? 'bg-secondary-900 text-green-400 border-secondary-800'
                                                        : 'bg-secondary-900 text-amber-400 border-secondary-800'
                                                    }`}
                                            >
                                                {step.code}
                                            </pre>
