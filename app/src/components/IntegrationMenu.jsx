...
const IntegrationMenu = ({ isOpen: sidebarOpen }) => {
  ...
  return (
    <div className="relative w-full" ref={dropupRef}>
      {isOpen && (
        <div className="absolute bottom-full left-0 mb-2 w-full bg-[var(--bg-card)] dark:bg-surface-900 text-surface-900 dark:text-white rounded-xl shadow-2xl border border-surface-200 dark:border-surface-800 z-50">
