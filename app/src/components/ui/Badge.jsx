...
const badgeVariants = cva(
  'inline-flex items-center gap-1 font-semibold transition-colors',
  {
    ...
    compoundVariants: [
      ...
      { variant: 'solid', color: 'info', className: 'bg-primary-600 text-white' },
      ...
      { variant: 'soft', color: 'info', className: 'bg-primary-50 text-primary-700 dark:bg-primary-900/30 dark:text-primary-300' },
      ...
      { variant: 'outline', color: 'info', className: 'border-primary-300 text-primary-600 dark:border-primary-600 dark:text-primary-400' },
    ],
    defaultVariants: {
      variant: 'soft',
      color: 'default',
