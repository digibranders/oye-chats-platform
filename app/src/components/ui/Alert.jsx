...
const config = {
  info: { icon: Info, bg: 'bg-primary-50 dark:bg-primary-900/20', border: 'border-primary-200 dark:border-primary-800', text: 'text-primary-800 dark:text-primary-200', iconColor: 'text-primary-500' },
