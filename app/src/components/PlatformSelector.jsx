    ...
    <div className="space-y-4">
      <div className="relative">
        ...
        <input
          ...
          className="w-full h-9 pl-9 pr-3 rounded-lg border border-surface-200 dark:border-surface-700 bg-white dark:bg-surface-800 text-surface-900 dark:text-white text-xs focus:ring-1 focus:ring-[var(--focus-ring)] focus:border-[var(--focus)] dark:focus:border-[var(--focus)] outline-none transition-all placeholder:text-surface-400 dark:placeholder:text-surface-500"
        />
      </div>
