          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2.5">
              <label className="block text-[13px] font-semibold text-[var(--ds-text)]">
                What type of feedback is this? <span className="font-normal text-[var(--ds-text-subtle)]">(required)</span>
              </label>
            ...
            {type === 'bug' && (
              <div className="space-y-2">
                <label className="block text-[13px] font-semibold text-[var(--ds-text)]">
                  Severity <span className="font-normal text-[var(--ds-text-subtle)]">(optional)</span>
                </label>
            ...
            <div className="space-y-2">
              <label htmlFor="fb-message" className="block text-[13px] font-semibold text-[var(--ds-text)]">
                Describe your feedback <span className="font-normal text-[var(--ds-text-subtle)]">(required)</span>
              </label>
