                        ...
                        if (msg.type === 'system') {
                            ...
                            items.push(
                                <div key={msg.id} className="mx-3 my-2" style={{ animation: 'fadeUp 0.3s ease-out' }}>
                                    <ErrorBoundary label="QuotationFlow" fallback={(retry) => <ChunkLoadNotice onRetry={retry} message="Couldn't load the quote." />}>
                                        <Suspense fallback={null}>
                                            <QuotationFlow
                                                sessionId={sessionId}
                                                settings={settings}
