        ...
        return (
            <div className="flex flex-col items-start w-full">
                <div className="w-full">
                    ...
                    {streamingId !== msg.id && (
                        <div className="flex items-center gap-1.5 mt-2 opacity-0 hover:opacity-100 transition-opacity duration-200">
                            <button
                            ...
                            <button
                                ...
                                className={`p-1 transition-colors ${msg.feedback === 'like' ? 'text-green-500' : 'text-gray-300 hover:text-green-500'}`}
                                title="Good response"
                            >
                            ...
                            <button
                                ...
                                className={`p-1 transition-colors ${msg.feedback === 'dislike' ? 'text-red-500' : 'text-gray-300 hover:text-red-500'}`}
                                title="Bad response"
                            >
    ...
    return (
        <div className="flex flex-col items-end">
            <div className="flex justify-end w-full">
                <div className={`max-w-[85%] px-4 py-3 text-[14px] ${currentTheme.userBubble}`}>
                    <div className="prose prose-sm max-w-none break-words">
                        <ReactMarkdown
                            components={{
                                a: ({ ...props }) => (
