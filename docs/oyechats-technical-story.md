# OyeChats — The Complete Technical Story

*Audience: engineers, architects, and technical evaluators. This is the system-design deep-dive — a single end-to-end narrative of the entire product: what it is, how it is put together, and how every part of it works, mechanism by mechanism — from the moment a stranger lands on the marketing page to the moment a refund is clawed back eleven months later. No framework names, no language names, no library trivia. Only the system, its flows, its pipelines, its state machines, and its failure modes.*

*For the non-technical, buyer-facing companion to this document — written for CEOs, CMOs, and marketing teams evaluating OyeChats commercially, with no system internals — see [`oyechats-marketing-story.md`](oyechats-marketing-story.md).*
