...
class TestTheQuestionIsRecognised:
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("which countries do you operate in", "locations"),
            ("do you operate in india", "locations"),
            ("are you available in other countries", "locations"),
            ("do you work across multiple cities", "locations"),
            ("what are your SOC centres", "locations"),
            ("what's your phone?", "contact"),
            ("can I get your whatsapp number", "contact"),
            ("your contact details please", "contact"),
            ("what is your phone no", "contact"),
            ("who are your founders", "team"),
            ("who are your owners?", "team"),
            ("tell me about your owners and directors", "team"),
            ("how many people work at your company", "team"),
            ("how many staff does your firm employ", "team"),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # Review 2026-09-17: a product, a venue, a plan limit or a skill, not the company.
            "does your phone support 5G",
            "does your whatsapp integration support templates",
            "how many people can the hall accommodate",
            "how many employees can use the pro plan",
            "do you deliver to Pune",
            "are you available to take a call tomorrow",
            "do you work in React",
